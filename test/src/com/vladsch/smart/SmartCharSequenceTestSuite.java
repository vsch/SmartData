...
@Suite.SuiteClasses({
        ...
        SmartCharArraySequenceTest.class,
        SmartCharSequenceTest.class,
        SmartCharSequenceWrapperTest.class,
        SmartReversedCharSequenceTest.class,
        SmartSegmentedCharSequenceTest.class,
